...
"""
    ...
    def __init__(self, spec_results, suite_results, browser_logs, seed=None,
                 colors=True):
    ...
    def format_deprecations(self):
        output = ""
        spec_deprecations = [
            result for result in self.results if result.deprecation_warnings]
        ...
        suite_deprecations = [
            result for result in self.suite_results
